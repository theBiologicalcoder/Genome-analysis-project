...
windows = []
no_windows=0
for i in range(0,len(genome),window_size): #allows us to make each window like 0-1000 of genome, and next 1k-2k of genome etc
...
#boxplot to compare mean GC values bw the genomes
plt.boxplot([mean_gcvalues, mean_GCvalues, mean_gccvalues])
plt.xticks([1,2,3], ["COVID", "Mycobacterium", "Plasmodium"])
plt.ylabel("GC content (%)")
